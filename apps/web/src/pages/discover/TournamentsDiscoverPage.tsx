...
const FEED_ITEMS: FeedItem[] = [
  {
    ...
    bgAlt: 'خشبة مسرح مضاءة بأضواء ذهبية لمسابقة إبداعية',
    category: 'شعر',
    title: 'أصوات الربيع — المرحلة النهائية',
    description: 'مشاركة مميزة في مسابقة الشعر الصوتي الكبرى — صوّت لتختار الفائز',
    creatorName: 'سلمى الحارثي',
    creatorHandle: '@salma.harithi',
    listens: '٤٢ ألف تصويت',
    duration: 'ينتهي خلال ٨ ساعات',
    likes: '٩.٣ك',
    comments: '٤١٢',
    avatarImage:
    ...
    avatarAlt: 'صورة المشاركة سلمى الحارثي',
  },
  {
    id: 't2',
    bgImage:
    ...
    bgAlt: 'إضاءة درامية لميكروفون في مسابقة قصة صوتية',
    category: 'قصة صوتية',
    title: 'حكّاء الأحلام — ربع النهائي',
    description: 'مسابقة أفضل قصة صوتية قصيرة — استمع وصوّت لأحب المشاركات إليك',
    creatorName: 'فارس النجار',
    creatorHandle: '@faris.najjar',
    listens: '٢٨ ألف تصويت',
    duration: 'ينتهي خلال ٢ يوم',
    likes: '٦.٧ك',
    comments: '٢٩٥',
    avatarImage:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuBNK3ytSH36YPuK5Y5uGUD1hNKqL885wssu5FS0uMxxunZi9NEUjnw9yXKcR3o3Cz8dmHiZOkToVNYvbAW-cXuUWhrIPcbLZVBE0Ahx1xzkUJZbCI7NlCCSdAaEBnLXSUKbKqeJ8URgfMjCbQbchqdlRy02ePlq3MK6eFSvjWaEOvomD3nbRcesyvbMkMe3fIicMwvqvdW3Jht44wZAzUkMXJUHttoqhpY0LiGco-L9U81UZBZfR_LSI3rn08Ad9pT1I3x5I3KP8umF',
    avatarAlt: 'صورة المشارك فارس النجار',
  },
  {
    id: 't3',
    bgImage:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuCS9to8gno-KMZxuSeaS_k8y_7LJtdbmqhPIorbh-0dwOcUtpvUJRZpAViIpXYx-6Zs_QVmjGSGJwX2d9GX0mggXxmcX2R5jXMD6FuoOfNqNOM83YACmVlgKKO7f-L_vuAbDqOCytVkDgaLcIOds2yd9HbzNWewiU4a9HUnBLA2fq6IOMOUc9K3rI5nJB2846GFiERAtxdaW2ODqNIBk67HmuHAtL388gEfdLUVOhtPDk9O0EH0zTFQeUwna1NqkIj_iNE6jI039YKX',
    bgAlt: 'ميدالية ذهبية وأضواء المسرح في مسابقة تلاوة',
    category: 'تلاوة',
    title: 'جوائز الصوت العربي — الدور الأول',
    description: 'مسابقة التلاوة الصوتية السنوية — اكتشف المشاركين واختر الأفضل',
    creatorName: 'ياسمين البكري',
    creatorHandle: '@yasmine.bakri',
    listens: '٥٥ ألف تصويت',
    duration: 'ينتهي خلال ٣ أيام',
    likes: '١١ك',
    comments: '٥٣٧',
    avatarImage:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuA2qHr5C5QGp0Q3uUeRhbgB0lejCNaO4UegUWuNgX2I20h5AgZZsGf2Be0pPxuewxjLmgdTwCJ75tQHfP93LMCgPErSmgAJdUtZzdVPkfFy_x4S84ZuoYMRFBZ9YOLsjiqD2z9DHdU7F2oO94psoCMMas9exXCB4qznISuwGGTjgKX-GradVYn6yHbMHgVPNIDV9Z99OCroyuA5SfN3v5IfoUxXUiqmasiLVw4qW1QewpJYLAnP_1fLeRp_4W6k4eiRYNySPTBGvX2n',
    avatarAlt: 'صورة المشاركة ياسمين البكري',
  },
];
  ...
  <div className="tdp-rail">
    ...
    <div className="tdp-avatar-wrap">
      ...
      <button
        ...
        aria-label={followed ? 'إلغاء المتابعة' : 'متابعة المشارك'}
    ...
    {/* Comments */}
    <button className="tdp-action-btn" aria-label="التعليقات">
      <span className="tdp-action-icon-box">
    ...
    >
      ...
      <span className="tdp-action-label">حفظ</span>
    </button>

    {/* Repost */}
    <button className="tdp-action-btn" aria-label="إعادة نشر">
      <span className="tdp-action-icon-box">
        <span className="material-symbols-outlined tdp-action-icon">repeat</span>
      </span>
      <span className="tdp-action-label">إعادة</span>
    </button>

    {/* Share */}
    <button className="tdp-action-btn" aria-label="مشاركة">
      <span className="tdp-action-icon-box">
        <span className="material-symbols-outlined tdp-action-icon">share</span>
      </span>
      <span className="tdp-action-label">مشاركة</span>
    </button>

    {/* Gift */}
    <button className="tdp-action-btn" aria-label="إرسال هدية">
      <span className="tdp-action-icon-box">
        <span className="material-symbols-outlined tdp-action-icon">card_giftcard</span>
      </span>
      <span className="tdp-action-label">هدية</span>
    </button>
  </div>
);
...
const TournamentsDiscoverPage: React.FC = () => {
  ...
  return (
    <div className="tdp-root" dir="rtl" lang="ar">
      ...
      <main className="tdp-main">
        ...
        <div className="tdp-subnav-cluster">
          <div className="tdp-glass-pill" role="tablist" aria-label="تصفية الاكتشاف">
